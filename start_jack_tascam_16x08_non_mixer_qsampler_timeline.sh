...
# Zita Verb
jack_connect  "Non-Mixer/ZitaVerb:aux-A/out-1"   "Non-Mixer/Main Out:in-1"  &
jack_connect  "Non-Mixer/ZitaVerb:aux-A/out-2"   "Non-Mixer/Main Out:in-2"  &
jack_connect  "Non-Mixer/ZitaVerb:out-1"         "Non-Mixer/HeadPhone:in-1"  &
jack_connect  "Non-Mixer/ZitaVerb:out-2"         "Non-Mixer/HeadPhone:in-2"  &
